...
async def reedme(e):
    await e.edit(
        ...
        "\n[Instant Setup - Generate String Session](https://GenerateStringSession.SpEcHIDe.repl.run)"
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click Here](https://github.com/GengKapak/DCLXVI) to see DCLXVI Official Repo.\n[Click Here](https://github.com/RonalAlfianto/DCLXVI) to see My Forked Repo"
    )
